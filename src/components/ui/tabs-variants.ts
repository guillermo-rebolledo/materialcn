...
export const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-m3-full p-1 text-muted-foreground group-data-horizontal/tabs:h-12 group-data-horizontal/tabs:data-[variant=line]:h-fit group-data-horizontal/tabs:data-[variant=primary]:h-fit group-data-horizontal/tabs:data-[variant=secondary]:h-fit group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:w-full data-[variant=line]:rounded-none data-[variant=line]:p-0 data-[variant=line]:border-b data-[variant=line]:border-m3-outline-variant data-[variant=primary]:w-full data-[variant=primary]:rounded-none data-[variant=primary]:border-b data-[variant=primary]:border-m3-outline-variant data-[variant=primary]:p-0 data-[variant=secondary]:w-full data-[variant=secondary]:rounded-none data-[variant=secondary]:border-b data-[variant=secondary]:border-m3-outline-variant data-[variant=secondary]:p-0",
  {
    variants: {
      variant: {
