...
**What to build:** Guidance on *choosing* tokens, not just on how the token layer
works. The README documents the mechanism thoroughly — where the tokens come
from, how the aliasing works, how to retheme — but a consumer deciding between
tertiary and secondary for an accent, or between a title and a label role for a
piece of text, has nothing to go on.
